...
@Component({
  selector: 'app-rechnung-a25',
  templateUrl: './rechnung-a25.component.html',
  styleUrls: ['./rechnung-a25.component.scss']
})
export class RechnungA25Component implements OnInit {
